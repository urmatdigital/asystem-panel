 ...
 */
function ISOInterval(source, enforceUTC = false) {
 ...
 */
function ISODate(source, options) {
  this.source = source;
  /** @type {number} */
  // @ts-ignore
 ...
 * @param {number} [offset]
 */
function ISODuration(source, offset = -1) {
  this.source = source;
 ...
 * @param {boolean} [enforceUTC] enforce UTC if source lacks timezone offset
 */
function parseInterval(isoInterval, enforceUTC) {
 ...
 * @param {boolean} [enforceUTC] enforce UTC if source lacks timezone offset
 */
function getDate(isoDateSource, enforceUTC) {
 ...
 * @param {boolean} [enforceUTC] enforce UTC if source lacks timezone offset
 */
function getExpireAt(isoInterval, compareDate, startDate, enforceUTC) {
 ...
 * @param {boolean} [enforceUTC] enforce UTC if source lacks timezone offset
 */
function getStartAt(isoInterval, compareDate, endDate, enforceUTC) {
